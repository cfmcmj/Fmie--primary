...
showBanner() {
  clear
  echo -e "$(cat << EOF
  echo -e "${RED}__/\\\\\\\\\\\\\\\__/\\\\____________/\\\\__/\\\\\\\\\\\__/\\\\\\\\\\\\\\\________________/\\\\\\\\\\\\\____/\\\________/\\\_        ${RESET}"
echo -e "${GREEN}_\/\\\///////////__\/\\\\\\________/\\\\\\\_/////\\\///__\/\\\///////////________________\/\\\/////////\\\_\///\\\____/\\\/__       ${RESET}"
echo -e "${YELLOW}_\/\\\_____________\/\\\//\\\____/\\\//\\\_____\/\\\_____\/\\\___________________________\/\\\_______\/\\\___\///\\\/\\\/____      ${RESET}"
echo -e "${BLUE}_\/\\\\\\\\\\\_____\/\\\\///\\\/\\\/_\/\\\_____\/\\\_____\/\\\\\\\\\\\______/\\\\\\\\\\\_\/\\\\\\\\\\\\\/______\///\\\/______     ${RESET}"
echo -e "${PURPLE}_\/\\\///////______\/\\\__\///\\\/___\/\\\_____\/\\\_____\/\\\///////______\///////////__\/\\\/////////__________\/\\\_______    ${RESET}"
echo -e "${CYAN}_\/\\\_____________\/\\\____\///_____\/\\\_____\/\\\_____\/\\\___________________________\/\\\___________________\/\\\_______   ${RESET}"
echo -e "${WHITE}_\/\\\_____________\/\\\_____________\/\\\_____\/\\\_____\/\\\___________________________\/\\\___________________\/\\\_______  ${RESET}"
echo -e "${RED}_\/\\\_____________\/\\\_____________\/\\\__/\\\\\\\\\\\_\/\\\\\\\\\\\\\\\_______________\/\\\___________________\/\\\_______ ${RESET}"
echo -e "${GREEN}_\///______________\///______________\///__\///////////__\///////////////________________\///____________________\///________${RESET}"    
EOF
)"
