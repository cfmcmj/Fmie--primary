...
showBanner() {
    clear
    echo -e "${CYAN}"
    echo -e "  ______  __  __  ______  ______  ______  ______  ______  ______  ______  ______  "
    echo -e " /\  ___\/\ \_\ \/\  __ \/\  == \/\  ___\/\  __ \/\  == \/\  == \/\  == \/\  ___\ "
    echo -e " \ \ \___\ \  __ \ \  __ \ \  _-/\ \  __\\\ \  __ \ \  _-/\ \  _-/\ \  _-/\ \ \____"
    echo -e "  \ \_____\ \_\ \_\ \_\ \_\ \_\   \ \_____\ \_\ \_\ \_\   \ \_\   \ \_\   \ \_____\\"
    echo -e "   \/_____/\/_/\/_/\/_/\/_/\/_/    \/_____/\/_/\/_/\/_/    \/_.    \/_/    \/_____/"
    echo -e "${RESET}"
    echo -e "${GREEN}欢迎使用 Fmie--primary 框架 v$VERSION${RESET}"
    echo -e "========================================\n"
}
